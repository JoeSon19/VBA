Attribute VB_Name = "HardcodeLookupFormulas_EntireWorkbook"
Sub HardcodeLookupFormulas_EntireWorkbook()
    ...
    MsgBox convertedCount & " lookup formula(s) converted to values across the workbook." ' Notify the user with the total converted count
